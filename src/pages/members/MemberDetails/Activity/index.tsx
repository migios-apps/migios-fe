...
import { customerActivityLog } from './logData'
...
const ActivitySection = ({ customerName }: { customerName: string }) => {
  const data = customerActivityLog
