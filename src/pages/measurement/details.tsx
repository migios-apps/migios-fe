        ...
        {measurement && !error && (
          <div className="flex flex-col gap-6">
            ...
            <Card>
              ...
              <div className="grid md:grid-cols-3 gap-4">
                ...
                <div className="flex flex-col">
                  ...
                  <span className="font-semibold">
                    {dayjs(measurement.created_at).format('DD MMMM YYYY HH:mm')}
                  </span>
                </div>
                <div className="flex flex-col">
                  <span className="text-sm text-gray-500">Diubah Pada</span>
                  <span className="font-semibold">
                    {dayjs(measurement.updated_at).format('DD MMMM YYYY HH:mm')}
                  </span>
                </div>
              </div>
            </Card>
            ...
            <Card>
              ...
              <div className="grid md:grid-cols-3 gap-4">
                <div className="flex flex-col">
                  <span className="text-sm text-gray-500">Berat Badan</span>
                  <span className="font-semibold">
                ...
                <div className="flex flex-col">
                  <span className="text-sm text-gray-500">Massa Otot</span>
                  <span className="font-semibold">
                ...
                <div className="flex flex-col">
                  <span className="text-sm text-gray-500">Massa Tulang</span>
                  <span className="font-semibold">
                ...
                <div className="flex flex-col">
                  <span className="text-sm text-gray-500">Usia Metabolik</span>
                  <span className="font-semibold">
                ...
                <div className="flex flex-col">
                  <span className="text-sm text-gray-500">Kadar Protein</span>
                  <span className="font-semibold">
                ...
                <div className="flex flex-col">
                  <span className="text-sm text-gray-500">Usia Tubuh</span>
                  <span className="font-semibold">
            ...
            <Card>
              ...
              <div className="grid md:grid-cols-3 gap-4">
                <div className="flex flex-col">
                  <span className="text-sm text-gray-500">Lingkar Leher</span>
                  <span className="font-semibold">
                    {measurement.neck_cm ? `${measurement.neck_cm} Cm` : '-'}
                  </span>
                </div>
                <div className="flex flex-col">
                  <span className="text-sm text-gray-500">Lengan Kanan</span>
                  <span className="font-semibold">
                ...
                <div className="flex flex-col">
                  <span className="text-sm text-gray-500">Lengan Kiri</span>
                  <span className="font-semibold">
                ...
                <div className="flex flex-col">
                  <span className="text-sm text-gray-500">Lingkar Dada</span>
                  <span className="font-semibold">
                    {measurement.chest_cm ? `${measurement.chest_cm} Cm` : '-'}
                  </span>
                </div>
                <div className="flex flex-col">
                  <span className="text-sm text-gray-500">Lingkar Perut</span>
                  <span className="font-semibold">
                ...
                <div className="flex flex-col">
                  <span className="text-sm text-gray-500">Lingkar Pinggul</span>
                  <span className="font-semibold">
                    {measurement.hip_cm ? `${measurement.hip_cm} Cm` : '-'}
                  </span>
                </div>
                <div className="flex flex-col">
                  <span className="text-sm text-gray-500">Paha Kanan</span>
                  <span className="font-semibold">
                ...
                <div className="flex flex-col">
                  <span className="text-sm text-gray-500">Betis Kanan</span>
                  <span className="font-semibold">
                ...
                <div className="flex flex-col">
                  <span className="text-sm text-gray-500">Betis Kiri</span>
                  <span className="font-semibold">
            ...
            <Card>
              ...
              <div className="flex flex-col gap-4">
                <div className="flex flex-col">
                  <span className="text-sm text-gray-500 mb-2">Penilaian</span>
                  <Tag
                    className={
                ...
                {measurement.notes && (
                  <div className="flex flex-col">
                    <span className="text-sm text-gray-500 mb-2">Catatan</span>
