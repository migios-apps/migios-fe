  ...
  return (
    <>
                ...
                {isLoadingRekenings ? (
                  ...
                  <>
                    {[...Array(6)].map((_, index) => (
                      <div
                        key={index}
                        className="bg-gray-200 dark:bg-gray-700 animate-pulse h-14 rounded-xl"
                      />
                    ))}
                  </>
                  ...
                  listRekenings.map((rekening) => {
                    return (
                      <Button
                        ...
                        type="button"
                        className={`bg-primary text-white py-4 rounded-xl flex items-center justify-center font-medium`}
                        onClick={() => {
                          if (
                            !isPaidOf &&
      ...
      <AlertConfirm
        ...
        onRequestClose={() => setConfirmVoid(false)}
