...
const EventGenerator: React.FC = () => {
  ...
  return (
    <div className="container mx-auto p-4">
      <h1 className="text-2xl font-bold mb-4">Event Generator</h1>
      ...
      <label className="block mb-2 font-semibold">End Type</label>
      <select
        value={endType}
        className="block w-full border border-gray-300 p-2 rounded mb-4"
      ...
      {(frequency === 'monthly' || frequency === 'yearly') && (
        <>
          <label className="block mb-2 font-semibold">Interval</label>
          <input
            type="number"
            value={interval}
            min="1"
      ...
      {frequency === 'yearly' && (
        <>
          <label className="block mb-2 font-semibold">Selected Months</label>
          <div className="flex flex-wrap gap-4 mb-4">
      ...
      {(frequency === 'weekly' ||
        ...
        frequency === 'yearly') && (
        <>
          <label className="block mb-2 font-semibold">Weekday Schedules</label>
      ...
      {generatedJSON && (
        <div className="mt-4">
          ...
          <pre className="bg-gray-100 p-4 rounded">{generatedJSON}</pre>
        </div>
      )}
    </div>
  )
